...
perl -p -e "s/SQLITE_THREADSAFE=1/SQLITE_THREADSAFE=2/g" "sqlite-autoconf-$VERSION/configure" > "sqlite-autoconf-$VERSION/configure~"
mv -f "sqlite-autoconf-$VERSION/configure~" "sqlite-autoconf-$VERSION/configure"
